...
CLoad3DS::CLoad3DS ()
{
  ...
  if (currentChunk == NULL) exit (300);
  tempChunk = new Chunk;
  if (tempChunk == NULL) exit (300);
}
...
void CLoad3DS::ReadVertexIndices (CObject *object, Chunk *previousChunk)
{
  ...
  if (object->triangle == NULL) exit (300);
...
void CLoad3DS::ReadVertices (CObject *object, Chunk *previousChunk)
{
  ...
  if (object->vertex == NULL) exit (300);
